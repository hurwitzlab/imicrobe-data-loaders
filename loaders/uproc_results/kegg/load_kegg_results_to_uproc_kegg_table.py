...
def get_args():
    ...
    argparser.add_argument('--drop-kegg-table', help='drop the KEGG table')
    argparser.add_argument('--create-kegg-table', help='create the KEGG table')

    argparser.add_argument('--results-root-dp', help='path to root of results directory tree')
    argparser.add_argument('--line-limit', default=None, type=int, help='number of lines to print in job file')
